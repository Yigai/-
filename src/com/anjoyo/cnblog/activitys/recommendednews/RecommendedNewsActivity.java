package com.anjoyo.cnblog.activitys.recommendednews;
...
public class RecommendedNewsActivity extends Activity {
	...
	Handler handler = new Handler() {
		...
		public void handleMessage(Message msg) {
			switch (msg.what) {
			case LOAD:
				adapter = new HotNewsAdapter(RecommendedNewsActivity.this, newsList);
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.recommendednews_layout);
		latestNewslist = (PullToRefreshListView) findViewById(R.id.latestNewslist);
		url = getIntent().getStringExtra("URL");
		touchListener = new TouchListener(RecommendedNewsActivity.this, false);
		...
		dialog = new ProgressDialog(RecommendedNewsActivity.this);
		...
		latestNewslist.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> listview, View item,
				...
				Intent intent = new Intent(RecommendedNewsActivity.this,
		...
		latestNewslist.setOnScrollListener(new OnScrollListener() {
			...
			public void onScroll(AbsListView view, int firstVisibleItem,
				...
				visiableItemCount = totalItemCount;
